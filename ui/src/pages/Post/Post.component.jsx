...
import { bestAnswer } from '../../redux/answers/answers.actions';

const Post = ({getPost, bestAnswer, post: {post, loading}, match}) => {
  useEffect(() => {
...
export default connect(mapStateToProps, {getPost, bestAnswer})(Post);
