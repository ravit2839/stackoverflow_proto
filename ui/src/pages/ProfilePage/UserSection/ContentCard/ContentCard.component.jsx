...
const ContentCard = ({ username, answers_count, posts_count, comments_count, tags_count, created_at, email, location, reputation }) => (
      ...
      <div className='info-cell'>
        <div className='info'>
          <div className='details'>
            <h2>{username}</h2>
            {email && <h3><b>Email:</b> &nbsp; {email}</h3>}
            {location && <h3><b>Location:</b> &nbsp; {location}</h3>}
          </div>
          <div className='date'>
            <p>
              user created &nbsp;-&nbsp;
